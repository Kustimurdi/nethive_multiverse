...
set_target_properties(libaec::aec-shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libaec.so.0.1.4"
  IMPORTED_SONAME_RELEASE "libaec.so.0"
  )

list(APPEND _cmake_import_check_targets libaec::aec-shared )
list(APPEND _cmake_import_check_files_for_libaec::aec-shared "${_IMPORT_PREFIX}/lib/libaec.so.0.1.4" )
