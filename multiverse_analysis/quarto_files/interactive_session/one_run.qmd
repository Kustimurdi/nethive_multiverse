...
filter_df = filter(row -> row.interaction_rate == 500, filter_df)
filter_df = filter(row -> row.dead_time == 1000, filter_df)
...
println("#suppressions by 4: ", nrow(filter(row -> row.bee2_id == 4, bee1_events)))
println("#suppressions by 5: ", nrow(filter(row -> row.bee2_id == 5, bee1_events)))
