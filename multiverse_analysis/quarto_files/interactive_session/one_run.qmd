...
#folder_path = "/scratch/n/N.Pfaffenzeller/nikolas_nethive/nethive_multiverse/test_gauss/2b2t_2"
folder_path = "/scratch/n/N.Pfaffenzeller/nikolas_nethive/nethive_multiverse/test_gauss/2b2t_complex"
folder_path = "/scratch/n/N.Pfaffenzeller/nikolas_nethive/nethive_multiverse/test_gauss/2b1t_sweep"
folder_path = "/scratch/n/N.Pfaffenzeller/nikolas_nethive/nethive_multiverse/test_gauss/2b2t_3"
folder_path = "/scratch/n/N.Pfaffenzeller/nikolas_nethive/nethive_multiverse/test_gauss/3b3t"
folder_path = "/scratch/n/N.Pfaffenzeller/nikolas_nethive/nethive_multiverse/test_gauss/3b3t_ls_sweep"
folder_path = "/scratch/n/N.Pfaffenzeller/nikolas_nethive/nethive_multiverse/gauss_runs/3b3t_sweep"
#folder_path = "/scratch/n/N.Pfaffenzeller/nikolas_nethive/nethive_multiverse/test_gauss/8b8t"
folder_path = "/scratch/n/N.Pfaffenzeller/nikolas_nethive/nethive_multiverse/test_gauss/3b3t_10_classes_low_recources"
...
folder_path = "/scratch/n/N.Pfaffenzeller/nikolas_nethive/nethive_multiverse/gauss_runs/real_time/4b4t20c50e/"
folder_path = "/scratch/n/N.Pfaffenzeller/nikolas_nethive/nethive_multiverse/gauss_runs/real_time/15b15t20c100e/"
folder_path = "/project/theorie/n/N.Pfaffenzeller/multiverse_2/gauss_runs/10b10t10c_long_sweep"
folder_path = "/scratch/n/N.Pfaffenzeller/nikolas_nethive/nethive_multiverse/resetting_runs/svhn_sweep"
folder_path = "/scratch/n/N.Pfaffenzeller/nikolas_nethive/nethive_multiverse/results/test_runs/10b10t15c1000e"
folder_path = "/scratch/n/N.Pfaffenzeller/nikolas_nethive/nethive_multiverse/results/test_runs/10b10t15c1000e_logsweep"
data_path = joinpath(folder_path, "data/")
master_df = build_master_dataframe(data_path)
```

```{julia}
filter_df = filter(row -> row.learning_rate == 5.0e-5, master_df)
#filter_df = filter(row -> row.learning_rate == 0.0005, master_df)
#filter_df = filter(row -> row.dataset_names == "[\"bank\"]", filter_df)
filter_df = filter(row -> row.interaction_rate == 1000.0, filter_df)
#filter_df = filter(row -> row.lambda_sensitivity == 100, filter_df)
filter_df = filter(row -> row.dead_time == 1.0, filter_df)
...
```{julia}
#run_path = "/scratch/n/N.Pfaffenzeller/nikolas_nethive/nethive_multiverse/gauss_runs/debug_run"
#run_path = "/scratch/n/N.Pfaffenzeller/nikolas_nethive/nethive_multiverse/test_gauss/no_interaction"
#run_path = "/scratch/n/N.Pfaffenzeller/nikolas_nethive/nethive_multiverse/test_gauss/one_task"
run_path = filter_df.run_path[2]
...
```{julia}
bee2log = filter(row -> row.bee1_id ==2, event_log)
```
